...
public class LogParserDisplayConsts {
    ...
    public LogParserDisplayConsts() {
        ...
        colorTable.put(LogParserConsts.OK, "grey");
        ...
        iconTable.put(LogParserConsts.OK, "grey.gif");
        ...
        linkListDisplay.put(LogParserConsts.OK, "OK");
        ...
        linkListDisplayPlural.put(LogParserConsts.OK, "OKs");
    }
