...
public class LogParserParser {
    ...
    public LogParserParser(final FilePath parsingRulesFile,
        ...
        statusCount.put(LogParserConsts.OK, 0);
    ...
    public LogParserResult parseLog(final Run<?, ?> build) throws IOException, InterruptedException {
        ...
        final String okLinksFilePath = logDirectory + "/logokLinks.html";
        ...
        linkFiles.put(LogParserConsts.OK, okLinksFilePath);
        ...
        writers.put(LogParserConsts.INFO, new BufferedWriter(new FileWriter(
                infoLinksFilePath)));
        writers.put(LogParserConsts.OK, new BufferedWriter(new FileWriter(
                okLinksFilePath)));
        ...
        ((BufferedWriter) writers.get(LogParserConsts.OK)).close();
        ...
        result.setTotalOKs((Integer) statusCount.get(LogParserConsts.OK));
